 ...
 */
public protocol FilterMultiSelectionSegmentedControlDelegate: class {
...
open class FilterMultiSelectionSegmentedControl: UIView {
    
    // MARK: - Private Properties
    fileprivate var _segmentButtons: [FilterMultiSelectionControlSegmentButton]?
    fileprivate var _items: [String]?
    
    // MARK: - Public Properties
    open weak var delegate: FilterMultiSelectionSegmentedControlDelegate?
    ...
    override open func layoutSubviews() {
        ...
        if subviews.count == 0 {
            ...
            for (index, segmentTitle) in items.enumerated() {
                ...
                let button = FilterMultiSelectionControlSegmentButton(frame: buttonFrame)
    ...
    open func insertSegmentWithTitle(_ title: String, atIndex segment: Int, animated: Bool) {
        ...
        let button = FilterMultiSelectionControlSegmentButton(frame: CGRect(x: self.frame.width, y: 0, width: 0, height: self.frame.height))
     ...
     */
    @objc fileprivate func _didTouchUpInsideSegment(_ segmentButton: FilterMultiSelectionControlSegmentButton) {
