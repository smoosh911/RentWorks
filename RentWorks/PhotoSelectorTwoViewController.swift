//
//  PhotoSelectorTwoViewController.swift
//  RentWorks
//
...
class PhotoSelectorTwoViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
